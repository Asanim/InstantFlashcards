...
import com.example.reference.MainActivity
import com.google.android.gms.tasks.Task
import com.google.mlkit.common.MlKitException
import com.example.reference.util.ImageUtils
import com.google.mlkit.vision.common.InputImage
import com.google.mlkit.vision.text.Text
import com.google.mlkit.vision.text.TextRecognition
import java.util.concurrent.Executor
//import com.google.mlkit.vision.text.chinese.TextRecognizerOptions
...
class TextAnalyzer(
    ...
    override fun analyze(imageProxy: ImageProxy) {
        ...
        recognizeTextOnDevice(InputImage.fromBitmap(convertImageToBitmap, 0)).addOnCompleteListener {
            imageProxy.close()
        }
    }
    ...
    private fun recognizeTextOnDevice(
        ...
        return detector.process(image)
            .addOnSuccessListener { visionText ->
                ...
                Log.d(TAG, "Average luminosity: $result")
            }
